...
export const WaysWeCanHelp = () => {
  ...
  return (
    <div className="w-full py-8 md:py-12 lg:py-16" style={{ background: 'linear-gradient(180deg, #FFF 37.11%, #E8E8E8 100%)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 mb-16 md:mb-20 lg:mb-24">
          ...
          <div className="flex flex-col justify-center w-full space-y-4 sm:space-y-6 lg:space-y-8">
            {/* Main Heading */}
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-medium leading-tight tracking-tight mb-3 lg:mb-4">
                <span style={{ color: '#0F1345' }}>What is an AI agent for </span>
                <span style={{ color: '#7409C5' }}>your Business</span>
              </h2>
              <p className="text-sm lg:text-base font-normal leading-relaxed tracking-tight text-ethos-gray">
        ...
        <div className="mb-16 md:mb-20 lg:mb-24">
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-medium leading-tight tracking-tight">
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6 md:gap-8 lg:gap-10 xl:gap-12">
              {services.map((service, index) => (
                <div
                  key={index}
                  className="w-full max-w-[320px] sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto bg-gradient-to-b from-gray-50 to-gray-100 rounded-[40px] sm:rounded-[50px] lg:rounded-[57px] p-4 sm:p-6 lg:p-8 xl:p-10 text-center hover:shadow-xl transition-shadow duration-300"
                  style={{
