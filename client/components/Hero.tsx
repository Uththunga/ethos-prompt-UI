        ...
        <div className="relative z-1 flex justify-center -mt-4" role="img" aria-label="AI Agent interface demonstration">
          <div className="relative">
            ...
            <img
              ...
              className="hidden lg:block absolute top-[calc(52.5%-27.5mm)] lg:top-[calc(53.5%-27.5mm)] left-[calc(59%-1.8mm)] lg:left-[calc(59%-1.8mm)] transform -translate-x-1/2 -translate-y-1/2 w-[46%] h-auto animate-float-slow"
              style={{ zIndex: 20 }}
            />
          </div>
        </div>
