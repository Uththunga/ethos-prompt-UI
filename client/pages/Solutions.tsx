...
export const Solutions = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-[#FEFEFE] to-[#FEFEFE] py-16 md:py-20 lg:py-24 xl:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Main Heading */}
          <div className="text-center mb-8 sm:mb-10 lg:mb-12">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-medium leading-tight tracking-tight">
          ...
          <div className="relative mb-3 sm:mb-4 lg:mb-6">
            <img
              src="/assets/images/ai-workflow-illustration.jpg"
              alt="AI Workflow Illustration showing various AI tools and integrations"
              className="w-full max-w-[550px] sm:max-w-[650px] md:max-w-[750px] lg:max-w-[850px] xl:max-w-[950px] 2xl:max-w-[1100px] mx-auto h-auto"
            />
          </div>
      ...
      <section className="py-16 md:py-20 lg:py-24 xl:py-28 bg-gradient-to-b from-[#FEFEFE] to-[#E6E6E6] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Two Column Layout */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-start">
            ...
            <div className="space-y-4 sm:space-y-6 lg:space-y-8">
              ...
              <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                <h3 className="text-ethos-gray text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium">
                  Our Services
                </h3>
                <div className="space-y-3 sm:space-y-4 lg:space-y-6 text-ethos-gray">
                  <div className="space-y-2">
                    <h4 className="text-base sm:text-lg lg:text-xl font-medium leading-snug">
                      Custom AI Agents
                    </h4>
            ...
            <div className="relative flex justify-center items-start pt-4 sm:pt-6 lg:pt-8">
              <img
                src="/assets/images/ai-workflow-diagram.svg"
                alt="AI Agent workflow diagram showing connections and integrations with productivity, financial, and communication tools"
                className="w-full max-w-[400px] sm:max-w-[480px] md:max-w-[560px] lg:max-w-[640px] xl:max-w-[720px] h-auto"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 lg:py-24 xl:py-28 bg-white relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="absolute inset-0 flex justify-center items-center">
            <img
              src="/assets/images/integration-background.png"
              alt="Integration applications background"
              className="w-full max-w-[2563px] h-auto object-contain"
            />
          </div>
          ...
          <div className="relative z-10 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center min-h-[300px] md:min-h-[350px] lg:min-h-[400px]">
              ...
              <div className="flex justify-center items-center">
                <img
                  src="/assets/images/App Logos.png"
